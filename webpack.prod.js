...
module.exports = merge(common, {
  ...
  optimization: {
    // runtimeChunk is necessary for code-splitting and lazy loading, as described
    // here: https://bundlers.tooling.report/code-splitting/multi-entry/
    // It "doesn't prevent Webpack from copying module code between entry points,
    // but it prevents it creating two instances of the same module at runtime".
    // This prevents problems such as each module having its own state, which
    // may get out of sync.
    runtimeChunk: "single",

    splitChunks: {
      minSize: 1, // default is 30000 (30k)
      maxSize: 20000,
      hidePathInfo: true,
      cacheGroups: {
        vendors: {
